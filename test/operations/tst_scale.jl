@testset "Scale" begin
    ...
    @testset "eager" begin
        ...
        @test @inferred(Augmentor.supports_eager(Scale)) === false
    ...
    @testset "lazy" begin
        @test @inferred(Augmentor.supports_lazy(Scale)) === true
    ...
    @testset "view" begin
        @test @inferred(Augmentor.supports_view(Scale)) === false
    end
    @testset "stepview" begin
        @test @inferred(Augmentor.supports_stepview(Scale)) === false
    end
    @testset "permute" begin
        @test @inferred(Augmentor.supports_permute(Scale)) === false
    end
end
