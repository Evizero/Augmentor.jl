...
3-step Augmentor.ImmutablePipeline:
 ...
 2.) Rotate 270 degree
 3.) No operation"""
@test str_showcompact(Augmentor.ImmutablePipeline(Rotate90(),Rotate270(),NoOp())) == "(Rotate 90 degree |> Rotate 270 degree |> No operation)"
@test str_showcompact(Augmentor.ImmutablePipeline(Rotate90())) == "(Rotate 90 degree)"
